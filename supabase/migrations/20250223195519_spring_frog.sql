...
CREATE TABLE clients (
  ...
  brand text,
  email text,
  reference_notes text, -- Changed from 'references' which is a reserved word
  created_at timestamptz DEFAULT now(),
  updated_at timestamptz DEFAULT now(),
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    -- Create the profile for the new admin user
    INSERT INTO profiles (id, email, full_name)
    VALUES (v_user_id, 'ruiguimaraes@lomartex.pt', 'Admin User');
  END IF;
END $$;